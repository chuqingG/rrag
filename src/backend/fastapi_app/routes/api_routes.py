...
from fastapi_app.dependencies import CommonDeps, DBSession, ImageEmbedModel, LocalChatClient
...
#             )
#             logging.info("[using advanced rag]")
#         else:
#             rag_flow = SimpleRAGChat(
#                 searcher=searcher,
#                 chat_model=local_llm,
#             )
#             logging.info("[using simple rag]")
...
async def chat_stream_handler(
    ...
    result = rag_flow.answer_stream(
        chat_params=chat_params, context=contextual_messages, results=results, earlier_thoughts=thoughts
    )
