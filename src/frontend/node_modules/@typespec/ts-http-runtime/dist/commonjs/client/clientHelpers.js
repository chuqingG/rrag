...
const bearerTokenAuthenticationPolicy_js_1 = require("../policies/bearerTokenAuthenticationPolicy.js");
...
const tokenCredential_js_1 = require("../auth/tokenCredential.js");
const keyCredential_js_1 = require("../auth/keyCredential.js");
...
function addCredentialPipelinePolicy(pipeline, endpoint, options = {}) {
    ...
    if ((0, tokenCredential_js_1.isTokenCredential)(credential)) {
        const tokenPolicy = (0, bearerTokenAuthenticationPolicy_js_1.bearerTokenAuthenticationPolicy)({
            credential,
    ...
    else if ((0, keyCredential_js_1.isKeyCredential)(credential)) {
