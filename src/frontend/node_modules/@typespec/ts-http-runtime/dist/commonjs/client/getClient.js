...
function getClient(endpoint, credentialsOrPipelineOptions, clientOptions = {}) {
    ...
    const client = (path, ...args) => {
        const getUrl = (requestOptions) => (0, urlHelpers_js_1.buildRequestUrl)(endpoint, path, args, Object.assign({ allowInsecureConnection }, requestOptions));
        return {
            get: (requestOptions = {}) => {
...
function isCredential(param) {
    return (0, keyCredential_js_1.isKeyCredential)(param) || (0, tokenCredential_js_1.isTokenCredential)(param);
}
