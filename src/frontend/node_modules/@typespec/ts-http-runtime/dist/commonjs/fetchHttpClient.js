...
exports.createFetchHttpClient = void 0;
...
async function buildPipelineResponse(httpResponse, request, abortControllerCleanup) {
    ...
    const bodyStream = (0, typeGuards_js_1.isReadableStream)(httpResponse.body)
...
function buildRequestBody(request) {
    ...
    return (0, typeGuards_js_1.isReadableStream)(body)
