                        ...
                        <ol>
                            {parsedAnswer.citations.map((rowId, ind) => {
                                ...
                                return (
                                    <li key={rowId}>
                                        <h4>
                                            <a href={citation.product_url} target="_blank" rel="noopener noreferrer">
                                                {citation.title}
                                            </a>
                                        </h4>
                                        {/* <p className={styles.referenceMetadata}>Link: {citation.product_url}</p> */}
                                        <p className={styles.referenceMetadata}>Price: {citation.price?.toFixed(2)}, Stars: {citation.stars?.toFixed(2)}</p>
