                ...
                <div className={styles.chatContainer}>
                    {!lastQuestionRef.current ? (
                        <div className={styles.chatEmptyState}>
                            ...
                            <h2 className={styles.chatEmptyStateTitle}>Relation RAG</h2>

                            {/* <h2 className={styles.chatEmptyStateSubtitle}>Currently supported categories: lamp blubs, bluetooth earbuds, formal suit, wristwatch, leggings, luggage, T-shirt, boots, vacuum, charger</h2> */}
                            <h3 className={styles.chatEmptyStateSubtitle}>On Amazon Product Dataset</h3>
                    ...
                    <div className={styles.chatInput}>
                        <QuestionInput
                            clearOnSend
                            placeholder="Ask anything ... (Currently supported: lamp blubs, bluetooth earbuds, formal suit, wristwatch, leggings, luggage, T-shirt, boots, vacuum, charger)"
                            disabled={isLoading}
